...
function setmatrices() {                                        //saving elements of matrix in array and showing operations
    ...
    options.innerHTML = '<span onclick="deter()">Find Determinent</span><br><span onclick="transpose()">Find Transpose</span><br><span onclick="inverse()">Find Inverse</span><br><span onclick="addscalar()">Add Scalar</span><br><span onclick="multiplyscalar()">Multiply a scalar</span><br>'
...
function addscalar() {                          //function to get scalar to add to matrix
    var addsc = document.createElement('p')
    addsc.innerHTML = '<label for="addsc">Enter scalar number to add to the matrix: </label><input type="number" name="" id="addsc"><span onclick="sumscalar()">OK</span>'
    document.getElementById('matopr').appendChild(addsc)
}
function sumscalar() {                          //performing addition
...
function multiplyscalar() {                     //function to get scalar to multiply to matrix
    var mulsc = document.createElement('p')
    mulsc.innerHTML = '<label for="mulsc">Enter scalar number to Multiply to the matrix: </label><input type="number" name="" id="mulsc"><span onclick="mulscalar()">OK</span>'
    document.getElementById('matopr').appendChild(mulsc)
}
function mulscalar() {                          //performing multiplication
    var mulsc = document.createElement('p')
